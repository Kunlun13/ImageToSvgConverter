...
function Header() {
  return (
    <div className='w-full' style={{fontFamily:"Sour Gummy",fontSize:"20px"}}>
    <div className='text-center bg-purple-600 p-8' style={{fontFamily:'Sour Gummy',fontSize:'60px'}}>Pi<span className='text-pink-400'>X</span>svg Creator</div>
    <header>
